...
date: "2020-01-24T14:35:52-05:00"
# [str] Gallery image file name. Image needs to be under 'images/'.
# If ommnited with type 'github', will attempt to fetch from '{repo_url}/.github/logo.png'.
image: "kitchenside.jpg"
...
github:
    ...
    repo: "YOUR-GITHUB-NAME/kitchenside"
...
![Kitchen Side](/images/kitchenside.jpg)
